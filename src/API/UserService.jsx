import{ AXIOS, ULR_GET_DVD_NAME_LIST, URL_DELETE_NEW_DVD_COPY, URL_GET_ACTORS_NAMES,
      ...
      URL_DELET_ALL_OLD_DVDS, URL_CURRENT_LOANS, URL_GET_DVD_UNPOPULAR, URL_GET_LAST_31_DAYS_LOAN_BY_LASTNAME, URL_GET_LAST_31_DAYS_LOAN_By_ID,
       URL_POST_NEW_REGISTER_USER, URL_GET_ALL_USERS_DETAIL, URL_POST_LOGIN, URL_CHANGE_PASSWORD_BY_ADMIN, URL_POST_CHANGE_OWN_PASSWORD, URL_POST_CHANGE_INFO_BY_ADMIN, URL_GET_CURRENT_USER_PROFILE_DETAIL, URL_POST_CURRENT_USER_PROFILE_DETAIL, URL_GET_MOST_LOAN
      } from "./Constant";
