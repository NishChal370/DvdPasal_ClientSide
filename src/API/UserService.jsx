import{ AXIOS, ULR_GET_DVD_NAME_LIST, URL_DELETE_NEW_DVD_COPY, URL_GET_ACTORS_NAMES,
       ...
       URL_POST_DVD, URL_POST_NEWMEMBER, URL_POST_NEW_DVD_COPY, URL_MEMBER_WITH_LOANS, URL_POST_LOAN, URL_GET_LAST_LOAN_BY_ID, URL_GET_LOANS, URL_POST_LOAN_RETURN_BY_ID, GET_INACTIVE_MEMBER_DETAIL, URL_GET_ALL_OLD_DVDS, URL_DELET_ALL_OLD_DVDS, URL_CURRENT_LOANS, URL_GET_DVD_UNPOPULAR, URL_GET_LAST_31_DAYS_LOAN_BY_LASTNAME, URL_GET_LAST_31_DAYS_LOAN_By_ID, URL_POST_NEW_REGISTER_USER, URL_GET_ALL_USERS_DETAIL
      } from "./Constant";
